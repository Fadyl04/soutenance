...
$query = $db->query("SELECT * FROM events ORDER BY start_date DESC LIMIT 6");
...
<head>
    ...
    <title>Événements au Bénin</title>
    ...
    <style>
        ...
        /* Modal styles pour la réservation */
        .modal-content {
            border-radius: 15px;
            border: none;
        }
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="d-flex flex-column justify-content-center">
                    <h1>Découvrez les événements au Bénin</h1>
                    <h2>Des moments inoubliables à partager</h2>
                    <a href="#featured-events" class="btn-get-started scrollto">Voir les événements</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <main id="main">
        ...
        <section id="featured-events" class="main-content">
            <div class="container">
                <div class="section-title">
                    <h2>Événements à venir</h2>
                    <p>Découvrez les événements culturels, sportifs et festifs qui animent le Bénin</p>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="category-filters text-center">
                            <a href="#featured-events" class="filter-btn active" data-filter="all">Tous</a>
                            <?php foreach ($categories as $key => $value): ?>
                                <a href="#featured-events" class="filter-btn" data-filter="<?= $key ?>">
                            ...
                            <div class="col-md-4 mb-4 event-item <?= $event['category'] ?? 'other' ?>">
                                <div class="event-card">
                                    ...
                                    <div class="event-info">
                                        ...
                                        <a href="detaills-events-paye.php?id=<?= $event['id'] ?>" class="read-more">En savoir plus</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <div class="text-center mt-4">
                    <a href="tous-evenementss.php" class="btn-get-started">Voir tous les événements</a>
                </div>
            </div>
        </section>
        ...
        <section id="categories" class="categories">
            <div class="container">
                <div class="section-title">
                    ...
                    <p>Explorez les événements selon vos centres d'intérêt</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="category-item">
                            <i class="bi <?= $category_icons[$key] ?? 'bi-calendar' ?>"></i>
                            <h3><?= $value ?></h3>
                            <p>Découvrez les <?= strtolower($value) ?> au Bénin qui vous feront vivre une expérience inoubliable.</p>
                            <a href="categorie-evenement.php?cat=<?= $key ?>" class="read-more mt-3">Explorer</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
