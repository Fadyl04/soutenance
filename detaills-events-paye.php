            ...
            <div class="row">
                ...
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="event-sidebar">
                        ...
                        <!-- Action Buttons -->
                        <div class="sidebar-widget">
                            <!-- Bouton de réservation modifié pour pointer vers process-payment.php -->
                            <button id="pay-btn" class="btn btn-primary w-100 mb-3"><i class="bi bi-ticket-perforated me-2"></i> Participer à l'événement</button>
...
<!-- Script pour FedaPay - Ajout des fichiers JS nécessaires -->
<script src="https://cdn.fedapay.com/checkout.js?v=1.1.7"></script>
...
<script type="text/javascript">
      FedaPay.init('#pay-btn', {
        ...
        transaction: {
          amount: <?php echo $event['amount_event']; ?>, // Utilisation du montant depuis la table events
          description: 'Réservation pour: <?php echo addslashes($event['label_event']); ?>'
        },
        onComplete: function(response){
            //Appelé après la tentative de paiement
            ...
            if(response.status === 'approved'){
                ...
                //Exemple: Redirection
                window.location.href = '/merci?event_id=<?php echo $id; ?>';
